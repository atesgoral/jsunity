...
assert.is = function (expected, actual, message) {
    if (actual !== expected) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

assert.isnt = function (expected, actual, message) {
    if (actual === expected) {
        throw new assert.AssertionError(message, actual, expected);
    }
};
...
assert.isFalse = function (actual, message) {
    assert.is(false, actual, message);
};

assert.match = function (expected, actual, message) {
    if (!expected.test(actual)) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

assert.notMatch = function (expected, actual, message) {
    if (expected.test(actual)) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

assert.typeOf = function (expected, actual, message) {
    if (typeof actual !== expected) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

assert.notTypeOf = function (expected, actual, message) {
    if (typeof actual === expected) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

assert.instanceOf = function (cls, actual, message) {
    if (!(actual instanceof expected)) {
        throw new assert.AssertionError(message, actual, expected);
    }
};

NotInstanceOf: function (cls, actual, message) {
...
assert.isntNull = function (actual, message) {
    if (actual === null) {
        throw fmt("?: (?) is null",
...
assert.isntUndefined = function (actual, message) {
    if (actual === undefined) {
...
assert.isntNaN = function (actual, message) {
    if (isNaN(actual)) {
        throw fmt("?: (?) is NaN",
...
//assert.AssertionError.prototype = Error;
